...
SELECT nombre, precio, ROUND((precio * 0.99),2) 
FROM producto
;
...
SELECT nombre AS `nombre de producto`, precio AS euros, ROUND((precio * 0.99),2) AS dolares 
FROM producto
;
...
-- Lista el nombre de todos los fabricantes en una columna, y 
-- en otra columna obtenga en mayúsculas los dos primeros caracteres del nombre del fabricante.
...
SELECT codigo_fabricante, nombre AS nombre_producto
FROM producto
;
